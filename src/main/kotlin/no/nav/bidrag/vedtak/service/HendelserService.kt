...
class HendelserService(private val vedtakKafkaEventProducer: VedtakKafkaEventProducer) {
  ...
  fun opprettHendelse(vedtakRequest: OpprettKomplettVedtakRequest, vedtakId: Int, opprettetTimestamp: LocalDateTime) {
  ...
  private fun mapVedtakshendelser(
    vedtakRequest: OpprettKomplettVedtakRequest, vedtakId: Int, opprettetTimestamp: LocalDateTime):List<VedtakHendelse> {
