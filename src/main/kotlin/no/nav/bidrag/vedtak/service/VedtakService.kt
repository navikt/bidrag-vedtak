...
import no.nav.bidrag.transport.behandling.vedtak.reponse.BehandlingsreferanseDto
import no.nav.bidrag.transport.behandling.vedtak.reponse.EngangsbelopDto
import no.nav.bidrag.transport.behandling.vedtak.reponse.GrunnlagDto
import no.nav.bidrag.transport.behandling.vedtak.reponse.StonadsendringDto
import no.nav.bidrag.transport.behandling.vedtak.reponse.VedtakDto
import no.nav.bidrag.transport.behandling.vedtak.reponse.VedtakPeriodeDto
